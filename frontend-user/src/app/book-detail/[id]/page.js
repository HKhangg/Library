          ...
          <div className="flex flex-col justify-between flex-1">
            ...
            <div className="flex items-center gap-5 mt-6">
              ...
              <Button
                ...
                className={`font-roboto font-bold py-2 px-4 rounded-3xl border-2 flex items-center gap-2 transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${
                  isAddedToCart
